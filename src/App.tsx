...
const Translations = {
  en: {
    title: 'Rejection',
    subtitle: 'Sampler',
    description: 'A visual tool for generating samples from complex probability distributions using the Rejection Sampling method.',
    ...
    copyright: '© 2024 Interactive Statistics Lab',
  ...
  cs: {
    title: 'Rejection',
    subtitle: 'Sampler',
    description: 'Vizuální nástroj pro generování vzorků ze složitých pravděpodobnostních rozdělení pomocí metody zamítacího vzorkování.',
    ...
    howItWorksDesc: 'Zamítací vzorkování funguje tak, že vygeneruje náhodný bod (X, Y) v ohraničujícím obdélníku. Pokud je Y menší než hustota pravděpodobnosti f(X), bod je přijat. V opačném případě je zamítnut.',
    mathFormula: 'Kritérium přijetí',
    copyright: '© 2024 Laboratoř interaktivní statistiky',
